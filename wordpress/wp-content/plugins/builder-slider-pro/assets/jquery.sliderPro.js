	...
	var Autoplay = {
		...
		_autoplayOnMouseLeave: function( event ) {
			if ( this.settings.autoplay === true && this.isTimerRunning === false && this.settings.autoplayOnHover !== 'stop' ) {
				var start = this.settings.timer_bar && this.settings.autoplayOnHover === 'pause' ? (this.$slider.find('.bsp-timer-bar').width() * 100) / this.$slider.width() : 0;
