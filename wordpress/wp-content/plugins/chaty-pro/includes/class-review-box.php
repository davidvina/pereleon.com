    ...
    public function admin_notices() {
        ...
        <div class="notice notice-info chaty-notice <?php echo $this->plugin_slug ?>-premio-review-box <?php echo $this->plugin_slug ?>-premio-review-box">
            <p>
                ...
                - <b>Gal Dubinski</b>, Co-founder <img width="30px" src="<?php echo esc_url(CHT_PLUGIN_URL."admin/assets/images/premio-owner.png") ?>" />
...
$Chaty_review_box = new Chaty_review_box();