...
<section class="section">
    <h1 class="section-title">
        <strong><?php esc_attr_e('Step', CHT_PRO_OPT); ?> 2:</strong> <?php esc_attr_e('Customize your widget', CHT_PRO_OPT); ?>
    </h1>
    ...
    <div class="form-horizontal">
                        ...
                        <div class="color-picker-custom">
                            <?php if ($this->is_pro()) : ?>
                                <div>
                                    ...
                                    <?php if ($color): ?>
                                        ...
                                        <?php esc_attr_e('Custom color', CHT_PRO_OPT); ?>
                                    <?php else: ?>
                                        <div class="circle">?</div><?php esc_attr_e('Custom color', CHT_PRO_OPT); ?>
                                    <?php endif ?>
                                </div>
                            ...
                            <?php else : ?>
                                ...
                                <div>
                                    ...
                                    <button class="btn-red"><?php esc_attr_e('Ok', CHT_PRO_OPT); ?></button>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <span class="text">
                            ...
                            if (!empty($color)) {
                                ...
                                if (isset($colors[$color])) {
                                    ...
                                    esc_attr_e('Custom', CHT_PRO_OPT);
                                }
                            } else {
                                esc_attr_e('Purple', CHT_PRO_OPT);
                            }
                            ?>
                        </span>
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="form-horizontal__item">
            ...
            <div>
                ...
                <label class="custom-control custom-radio" for="left-position">
                    ...
                    <span class="custom-control-label"><?php esc_attr_e('Left', CHT_PRO_OPT); ?></span>
                </label>
                ...
                <label class="custom-control custom-radio" for="right-position">
                    ...
                    <span class="custom-control-label"><?php esc_attr_e('Right', CHT_PRO_OPT); ?></span>
                </label>
                ...
                <?php if ($this->is_pro()) : ?>
                    <label class="custom-control custom-radio" for="positionCustom">
                        ...
                        <span class="custom-control-label">
                            <?php esc_attr_e('Custom', CHT_PRO_OPT); ?>
                        </span>
                    </label>
                <?php else: ?>
                    <span class="custom-control custom-radio free-custom-radio" style="pointer-events: none">
                        <input type="radio" class="custom-control-input" disabled>
                        <span class="custom-control-label"><?php esc_attr_e('Custom', CHT_PRO_OPT); ?> </span>
                    </span>
                    <a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_PRO_OPT); ?>)</a>
                <?php endif; ?>
                ...
                <div id="positionPro" style="display: <?php esc_attr_e(($position === 'custom') ? 'block' : 'none'); ?>" >
                    <div class="position-pro">
                        ...
                        <div>
                            <label><?php esc_attr_e('Bottom spacing', CHT_PRO_OPT); ?>:</label>
                        ...
                        <div>
                            <label><?php esc_attr_e('Side spacing', CHT_PRO_OPT); ?>:</label>
        ...
        <?php // Call to Action ?>
        <div class="form-horizontal__item">
            <label class="align-top form-horizontal__item-label"><?php esc_attr_e('Call to action', CHT_PRO_OPT); ?>:</label>
            <div>
                ...
                ?>
                <textarea type="text" data-gramm_editor="false" class="test_textarea" cols="40" rows="2" name="cht_cta" value="<?php echo esc_attr_e(wp_unslash($cta)) ?>" placeholder="<?php esc_attr_e('Message us!', CHT_PRO_OPT); ?>" onkeydown="return limitLines(this, event)"><?php esc_attr_e($cta) ?></textarea>
            </div>
        </div>
        ...
        <div class="form-horizontal__item widget-icon__block">
            ...
            <label class="widget-icon__wrap <?php esc_attr_e($pro_class)  ?>">
                <label class="custom-control custom-radio">
                    <input type="radio" name="widget_icon" class="custom-control-input js-widget-i " value="chat-base" data-type="chat-base" data-gramm_editor="false" <?php checked($widget_icon, "chat-base") ?> <?php esc_attr_e($disabled) ?> />
                ...
                <?php if (!$this->is_pro()): ?>
                    <a class="custom-control custom-radio " href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>" target="_blank">
                <?php else: ?>
                    <label class="custom-control custom-radio <?php if (!$this->is_pro()) { esc_attr_e('easy-modal-open'); } ?>" href="#upgrade-modal">
                <?php endif; ?>
                        <input type="radio" name="widget_icon" class="custom-control-input js-widget-i" value="chat-smile" data-type="chat-smile" data-gramm_editor="false" <?php checked($widget_icon, "chat-smile") ?> <?php esc_attr_e($disabled) ?> >
            ...
            <?php else: ?>
                <label class="custom-control custom-radio">
            <?php endif; ?>
                <input type="radio" name="widget_icon" class="custom-control-input js-widget-i" value="chat-bubble" data-type="chat-bubble" data-gramm_editor="false" <?php checked($widget_icon, "chat-bubble") ?> <?php esc_attr_e($disabled) ?> />
            ...
            <?php if (!$this->is_pro()): ?>
            <a class="custom-control custom-radio " href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>"
               target="_blank">
                <?php else: ?>
                <label class="custom-control custom-radio">
                    <?php endif; ?>
                    <input type="radio" name="widget_icon" class="custom-control-input js-widget-i" value="chat-db" data-type="chat-db" data-gramm_editor="false" <?php checked($widget_icon, "chat-db") ?> <?php esc_attr_e($disabled) ?> />
            ...
            <?php if (!$this->is_pro()): ?>
                <a class="upgrade-link" target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_PRO_OPT); ?>)</a>
            <?php endif; ?>
    ...
    <div class="form-horizontal__item">
        ...
        <div>
            ...
            ?>
            <input type="number" min="24" max="100" name="cht_widget_size" class="widget-size__input" data-gramm_editor="false" value="<?php echo esc_attr($size); ?>" <?php if (!$this->is_pro()) echo 'disabled'; ?> />
            <span class="custom-control-label">px
                <?php if (!$this->is_pro()): ?><a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_PRO_OPT); ?>)</a><?php endif ?>
            </span>
        </div>
    </div>
    ...
    <div class="form-horizontal__item flex-center">
        ...
        <label class="form-horizontal__item-label"><?php esc_attr_e('Google Analytics', CHT_PRO_OPT);?>:</label>
        <div>
            <label class="switch">
                <?php
                $checked = get_option('cht_google_analytics'.$this->widget_index);
                ?>
                <span class="switch__label"><?php esc_attr_e('Off', CHT_PRO_OPT);?></span>
                ...
                <span class="switch__label"><?php esc_attr_e('On', CHT_PRO_OPT);?></span>
                <?php if (!$this->is_pro()): ?><a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_PRO_OPT); ?>)</a><?php endif ?>
            </label>
        </div>
    </div>
        ...
        <?php else: ?>
            ...
            <div>
                <label class="custom-control custom-checkbox free-custom-checkbox">
                    ...
                    <span class="custom-control-label"><?php esc_attr_e('Remove "Get widget" link', CHT_PRO_OPT); ?></span>
                </label>
                <a target="_blank" href="<?php echo esc_url($this->getUpgradeMenuItemUrl()); ?>">(<?php esc_attr_e('Activate your license key', CHT_PRO_OPT); ?>)</a>
            </div>
        <?php endif; ?>
