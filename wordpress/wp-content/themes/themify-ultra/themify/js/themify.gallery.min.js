...
b.addEventListener("click",function(b){ThemifyBuilderModuleJs.sharer(b.target.dataset.type,a.currItem.data.src.replace("?iframe=true",""),a.currItem.data.title);return!1})},updateHash:function(a,b){if("open"===a){null===ThemifyGallery.origHash&&(ThemifyGallery.origHash=window.location.hash);var c=b.currItem.data.title;var f=document.createElement("div");f.innerHTML=c;c=f.textContent.trim();""!==c&&this._updateHash(c)}else c=ThemifyGallery.origHash,this._updateHash(c),ThemifyGallery.origHash=null},
_updateHash:function(a){"#"!==(""+a).charAt(0)&&(a="#"+a);history.replaceState("","",a)},openAnchor:function(){if(""!==window.location.hash){var a=decodeURI(window.location.hash.substring(1)),b=document.querySelector('[alt="'+a+'"]'),b=null===b?document.querySelector('[title="'+a+'"]'):b;null!==b&&b.click()}}}})(jQuery);
